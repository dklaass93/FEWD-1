$(document).ready(function(){
	...
	$('#newEntry').submit(sumTotalAndNewEntry);
...
/*$(document).ready(function(){
	...
	function sumTotalAndNewEntry(event){
		...
		//Finding the ID entries in the HTML and creating a new table row
		$('#entries').append('<tr><td>'+entryNewCurrency+'</td><tr>')

		//Finding the ID total in the HTML and updating the text to the value of the total currency
